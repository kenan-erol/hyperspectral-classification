...
def train(model,
    ...
    # temporarily put this to test cifar. need to be removed
    ...
    # print("in train cnn", file=sys.stdout)
    ...
    for epoch in range(n_epoch):
        ...
        # torch.save(model_checkpoint_path.format(epoch), epoch, optimizer)
		...
		# 	'loss': mean_loss,
		# }, model_checkpoint_path.format(epoch))
  
        model.eval()
  
        evaluate(model, dataloader_test, dataset_test.classes, None, "cuda")
